...
==============================
v25.0: Native Tech-Noir Architecture.
       - Zero-breakage logic preservation.
       - Config.toml reliant rendering.
       - Preserved sidebar navigation matrix and guest auth.
"""
import sys, os
...
with st.sidebar:
    ...
    for icon, tab in NAV_ITEMS:
        ...
        # Native Streamlit Routing buttons
