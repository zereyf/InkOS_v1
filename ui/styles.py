...
v4.2: NUKE-PROOF COMMAND PILL
- Penetrated Streamlit's hidden [data-baseweb] to force transparency.
- Corrected flex widths so the button never gets pushed off screen.
"""
...
[data-testid="collapsedControl"], [data-testid="collapsedControl"] svg { color: var(--gold) !important; fill: var(--gold) !important; }
...
/* ══════════════════════════════════════════
   THE CHATGPT PILL ILLUSION (Nuclear Fix)
══════════════════════════════════════════ */
/* 1. The Outer Pill Container */
...
/* 2. Lock Column Proportions tightly so nothing gets shoved out */
...
/* 3. 🚨 THE NUKE: Destroy Streamlit's inner grey backgrounds completely 🚨 */
div[data-testid="stHorizontalBlock"]:has(.command-pill-marker) [data-testid="stTextArea"],
div[data-testid="stHorizontalBlock"]:has(.command-pill-marker) [data-baseweb="textarea"],
div[data-testid="stHorizontalBlock"]:has(.command-pill-marker) [data-baseweb="base-input"],
div[data-testid="stHorizontalBlock"]:has(.command-pill-marker) [data-baseweb="base-input"] > div {
...
div[data-testid="stHorizontalBlock"]:has(.command-pill-marker) [data-baseweb="textarea"] textarea {
    background: transparent !important;
    background-color: transparent !important;
...
div[data-testid="stHorizontalBlock"]:has(.command-pill-marker) [data-baseweb="textarea"] textarea:focus {
    box-shadow: none !important;
...
.stButton > button:not([title="Compile Blueprint"]):focus { animation: borderPulse 1.2s ease 2 !important; outline: none !important; }

.stDownloadButton > button { background: transparent !important; border: 1px solid var(--text-dim) !important; color: var(--text-muted) !important; font-family: var(--font-m) !important; font-size: 0.65rem !important; letter-spacing: 0.1em !important; border-radius: 2px !important; }
...
.stTabs [data-baseweb="tab-list"] { background: transparent !important; border-bottom: 1px solid var(--text-dim) !important; gap: 0 !important; display: flex !important; flex-wrap: wrap !important; }
.stTabs [data-baseweb="tab"] { font-family: var(--font-m) !important; font-size: 0.65rem !important; letter-spacing: 0.14em !important; text-transform: uppercase !important; color: var(--text-muted) !important; background: transparent !important; border: none !important; border-bottom: 2px solid transparent !important; padding: 10px 12px !important; transition: color 0.2s !important; white-space: nowrap !important; }
...
.rtl-mode .vc-header, .rtl-mode .vc-wordmark, .rtl-mode .score-lbl, .rtl-mode .p-label, .rtl-mode .p-paradigm { direction: rtl !important; text-align: right !important; font-family: var(--font-a) !important; letter-spacing: 0 !important; }
