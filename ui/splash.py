...
def render_splash_screen():
    ...
    <div style="border-left: 3px solid var(--gold); padding-left: 15px; margin-bottom: 30px; margin-top: 20px;">
    ...
    """)
    st.markdown(about_html if 'about_html' in locals() else splash_html, unsafe_allow_html=True)
