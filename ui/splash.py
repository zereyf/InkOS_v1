...
def render_splash_screen():
    ...
    <div style="max-width: 700px; margin: 40px auto; padding: 30px; background: var(--bg-card); border: 1px solid rgba(255,255,255,0.05); border-radius: 4px; box-shadow: 0 10px 30px rgba(0,0,0,0.5);">
        ...
        <div style="border-left: 3px solid var(--gold); padding-left: 20px; margin-bottom: 40px;">
            <h1 style="font-family: var(--font-d); color: var(--gold); margin: 0; font-size: 2.5rem; letter-spacing: 2px;">حبر وفكرة</h1>
            <span style="font-family: var(--font-m); font-size: 0.75rem; color: var(--text-dim); letter-spacing: 4px;">INKOS V2026.4 // VELVETCODEX INITIATIVE</span>
        </div>
        
        <!-- INTRO -->
        <div style="margin-bottom: 30px; font-family: var(--font-m); font-size: 0.9rem; color: var(--text); line-height: 1.7;">
            Most interfaces are soulless. InkOS is a highly opinionated intelligence terminal designed for precision, speed, and ethical rigor. 
            It does not just generate text; it refracts intent through specialized cognitive frameworks.
        </div>

        <!-- ARCHITECTURE SPECS -->
        <div style="background: rgba(0,0,0,0.3); border: 1px solid rgba(255,255,255,0.03); padding: 20px; margin-bottom: 30px;">
            <div style="font-family: var(--font-m); font-size: 0.65rem; color: var(--gold); letter-spacing: 2px; text-transform: uppercase; margin-bottom: 15px;">> System Architecture</div>
        ...
        <!-- AUTHOR SIGNATURE -->
        <div style="display: flex; justify-content: space-between; align-items: flex-end; border-top: 1px solid rgba(255,255,255,0.05); padding-top: 20px;">
            <div>
